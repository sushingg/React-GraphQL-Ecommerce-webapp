...
class Checkout extends Component {
  ...
  render() {
    ...
    if (items !== null) {
      var orderTotal =
        items.reduce((acc, { productPrice }) => acc + productPrice, 0) || "";
                      ...
                      <Form size="large">
                        <Segment>
                          <Form.Input
                            ...
                            onChange={e =>
                              this.setState({ orderFirstname: e.target.value })
                            }
                          />
                          <Form.Input
                            fluid
                            ...
                            onChange={e =>
                              this.setState({ orderLastname: e.target.value })
                            }
                          />
                          <Form.Input
                            fluid
                            ...
                            placeholder="Address"
                            onChange={e =>
                              this.setState({ orderAddr1: e.target.value })
                            }
                          />
